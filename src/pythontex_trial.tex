...
% cross reference (currently not used)
% \zxrsetup{toltxlabel} % use normal LaTeX style \ref
% \zexternaldocument*[1:]{reference/foo} % usage: \zexternaldocument*[prefix]{path/to/aux/file/without/extension}[path/to/pdf/file] Only ascii name is allowed.
...
\begin{document}
    ...
    \input{programs/common_pycodes.tex}
